...
- Dashboard admin : section "Top 5 contributeurs" avec score pondéré par type d'action
- Dashboard admin : section "Widgets les plus utilisés" avec barre de progression par widget
- "Jamais connectés" renommé "Jamais actifs" — métrique plus précise

---

## v1.28 — 26-08-2026 🏷️ Stable
### Nouveau
- Module Santé : calculs IMC, métabolisme de base, dépense énergétique, objectif calorique, macros (protéines / glucides / lipides)
...
## v1.16 — 26-08-2026
### Corrections
- Conseil cycle IA tronqué sur mobile — texte désormais complet
...
## v1.08 — 24-08-2026
### Nouveau
- Mentions @utilisateur en temps réel dans les posts et commentaires
- Suggestions interactives au clavier et à la souris
- Mentions cliquables menant au profil public de l'utilisateur
